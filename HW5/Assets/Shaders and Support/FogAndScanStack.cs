...
public sealed class FogAndScanStack : PostProcessEffectSettings {
    ...
    public FloatParameter speed = new FloatParameter { value = 0.61f };
    ...
    public FloatParameter colorR = new FloatParameter { value = 0.4f };
    [Range(0f, 1f), Tooltip("Speed of crossfade effect.")]
    public FloatParameter colorG = new FloatParameter { value = 0.49f };
    [Range(0f, 1f), Tooltip("Speed of crossfade effect.")]
    public FloatParameter colorB = new FloatParameter { value = 1f };
//    [Range(0f,1f), Tooltip("Speed of crossfade effect.")]
